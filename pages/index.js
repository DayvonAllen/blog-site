            ...
            <div className="max-w-4xl mx-auto">
              <dl className="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                <div className="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                  <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500">Last 30 Days</dt>
                  <dd className="order-1 text-5xl font-extrabold text-indigo-600">1,000</dd>
                </div>
                <div className="flex flex-col border-t border-b border-gray-100 p-6 text-center sm:border-0 sm:border-l sm:border-r">
                  <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500">Last 60 Days</dt>
                  <dd className="order-1 text-5xl font-extrabold text-indigo-600">5,000</dd>
                </div>
                <div className="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                  <dt className="order-2 mt-2 text-lg leading-6 font-medium text-gray-500">Unique Visitors</dt>
                  <dd className="order-1 text-5xl font-extrabold text-indigo-600">10,000</dd>
                </div>
              </dl>
            </div>
          </div>
